...
# ==========================================
# 3. UI और जादुई कंट्रोल बॉक्स (DEPLOYMENT)
# ==========================================
st.set_page_config(page_title="🛡️ ब्लैक कमांडो V12.2", layout="wide")

def main():
    st.title("🛡️ मिशन: ब्लैक कमांडो V12.2")
    st.caption("आज्ञा से: राजा साहब | वेल्थ और कंपाउंडिंग मोड: एक्टिव")
    ...
    # वेल्थ मैसेज (Compounding Status)
    st.success(f"🚀 **कंपाउंडिंग एक्शन:** आज ₹{int(today_wealth)} को वेल्थ (Nifty/Gold BEES) के लिए सुरक्षित कर दिया गया है।")
    st.info(f"💡 इसमें शामिल है: ₹150 (System) + ₹{user_sip_input/20} (User) + 50% Profit")
    ...
    st.divider()
    st.caption("📉 सिस्टम अब आपकी पिछली जीत-हार से खुद को रोज़ाना बेहतर बना रहा है।")
